...
public class FiltrosActivity extends AppCompatActivity {
    ...
    private void configCliques(){
        findViewById(R.id.btn_limpar).setOnClickListener(view -> {
            SPFiltro.LimparFiltros(this);
            finish();
        });
        findViewById(R.id.ib_voltar).setOnClickListener(view -> finish());

        btn_regioes.setOnClickListener(view -> {
            Intent intent = new Intent(this, RegioesActivity.class);
            intent.putExtra("filtros", true);
            startActivity(intent);
        });
        btn_estados.setOnClickListener(view -> {
        ...
        findViewById(R.id.btn_filtrar).setOnClickListener(view -> {
            recuperaValores();
            finish();
        });
    }
