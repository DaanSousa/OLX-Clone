...
public class DetalhesAnuncioActivity extends AppCompatActivity {
    ...
    private TextView tex_municipio_anuncio;
    ...
    private void alertAutenticacao(String msg){
        ...
        builder.setTitle("Você não esta autenticado.");
        builder.setMessage(msg);
        builder.setNegativeButton("Não",((dialog, i) -> {
            dialog.dismiss();
    ...
    private void configCliques(){
        ...
        findViewById(R.id.ib_ligar).setOnClickListener(view -> ligarAnunciante());
    ...
    private void configDados(){
        ...
        tex_municipio_anuncio.setText(anuncio.getLocal().getLocalidade());
    ...
    private void iniciaComponentes(){
        ...
        tex_municipio_anuncio = findViewById(R.id.tex_municipio_anuncio);
