...
public class CategoriaList {
    ...
    public static List<Categoria> getList(boolean todas){
        ...
        categoriaList.add(new Categoria(R.drawable.ic_eletronico_e_celulares, "Eletronicos e celulares"));
        ...
        categoriaList.add(new Categoria(R.drawable.ic_servicos, "Servicos"));
        categoriaList.add(new Categoria(R.drawable.ic_vagas_de_emprego, "Vadas de emprego"));
